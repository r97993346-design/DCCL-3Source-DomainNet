...
# Augmented CIPTDCCL view.  Keep the existing DCCL augmentation semantics and
# strengths, but make the image that reaches frozen CLIP use bicubic sampling
# and CLIP's own normalization statistics.
clip_aug = T.Compose([
    T.RandomResizedCrop(
        224,
        scale=(0.7, 1.0),
