...
PICCL_KEYS = ["lr","weight_decay","piccl_rank","piccl_alpha_max","piccl_lr_multiplier","piccl_ccc_weight","piccl_connectivity_weight","piccl_isr_weight","piccl_orth_weight","piccl_inv_weight","piccl_residual_scale","piccl_gate_bias","piccl_delayed_start_ratio","piccl_loss_warmup_ratio","piccl_feature_warmup_ratio","piccl_fusion_mode","t","piccl_gt_mode","piccl_int_weight","piccl_ref_weight","piccl_warmup_ratio","piccl_ramp_ratio"]
