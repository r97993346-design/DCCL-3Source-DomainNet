...
def main():
    ...
    parser.add_argument("--use_dfa", action="store_true", help="Enable Full DFA module (CDC + PMA + GT losses)")
    parser.add_argument("--l_cdc", type=float, default=0.1, help="Weight for CDC loss in DFA")
    parser.add_argument("--l_pma", type=float, default=0.1, help="Weight for PMA loss in DFA")
    parser.add_argument("--l_gt", type=float, default=0.1, help="Weight for GT loss in DFA")

    parser.add_argument("--dfa_dim", type=int, default=0)
    parser.add_argument("--dfa_use_dfd", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--dfa_use_advm", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--dfa_use_dr", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--dfa_use_cr", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--dfa_mask_ratio", type=float, default=0.6)
    parser.add_argument("--dfa_gumbel_tau", type=float, default=0.5)
    parser.add_argument("--lambda_dfa_cls", type=float, default=1.0)
    parser.add_argument("--lambda_dfa_inv", type=float, default=1.0)
    parser.add_argument("--lambda_dfa_cl", type=float, default=0.005)
    parser.add_argument("--dfa_inv_rampup_epochs", type=int, default=5)
    parser.add_argument("--dfa_inference_head", type=str, default="invariant", choices=["invariant","dccl"])
    parser.add_argument("--dfa_require_domain_balanced_batch", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--dfa_log_fallback_stats", action=argparse.BooleanOptionalAction, default=True)
