...
def main():
    ...
    parser.add_argument("--use_fourier_intervention", type=lambda x: str(x).lower() in ["1", "true", "yes"], default=False)
    ...
    parser.add_argument("--use_adversarial_masker", type=lambda x: str(x).lower() in ["1", "true", "yes"], default=False)
    ...
    parser.add_argument("--gumbel_hard", type=lambda x: str(x).lower() in ["1", "true", "yes"], default=True)
