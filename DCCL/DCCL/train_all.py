...
def main():
    ...
    # DiffuseMix causal positive options (disabled by default)
    parser.add_argument("--use_diffusemix_pos", action="store_true", help="Enable DiffuseMix/InstructPix2Pix causal positive branch")
    parser.add_argument("--diffusemix_model_path", type=str, default="", help="Local InstructPix2Pix model path")
    parser.add_argument("--diffusemix_cache_dir", type=str, default="dccl_diffusemix_cache", help="DiffuseMix cache root")
    parser.add_argument("--diffusemix_use_cache_first", action=argparse.BooleanOptionalAction, default=True, help="Reuse cached valid samples before generation")
    parser.add_argument("--diffusemix_regenerate_if_cache_empty", action="store_true", help="Generate when cache is empty")
    parser.add_argument("--diffusemix_cache_max_per_image", type=int, default=4)
    parser.add_argument("--diffusemix_max_cached_used_per_image", type=int, default=1)
    parser.add_argument("--diffusemix_save_kept_only", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--diffusemix_save_rejected", action="store_true")
    parser.add_argument("--diffusemix_generate_prob", type=float, default=0.25)
    parser.add_argument("--diffusemix_max_per_step", type=int, default=8)
    parser.add_argument("--diffusemix_prompt_mode", type=str, default="diffusemix_official", choices=["diffusemix_official"])
    parser.add_argument("--diffusemix_prompts", type=str, default="Autumn,snowy,watercolor art,sunset,rainbow,aurora,mosaic,ukiyo-e,a sketch with crayon", help="Comma-separated DiffuseMix prompts from the official implementation")
    ...
    parser.add_argument("--diffusemix_supcon_start_steps", type=int, default=7500)
    parser.add_argument("--diffusemix_use_supcon_positive", action=argparse.BooleanOptionalAction, default=False)
    parser.add_argument("--diffusemix_filter_conf", type=float, default=0.5)
    parser.add_argument("--diffusemix_use_reliability_gate", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--diffusemix_min_reliability", type=float, default=0.4)
    parser.add_argument("--diffusemix_strong_reliability", type=float, default=0.7)
    parser.add_argument("--diffusemix_min_keep_rate", type=float, default=0.1)
    parser.add_argument("--diffusemix_strong_conf", type=float, default=0.7)
    parser.add_argument("--diffusemix_filter_kl", type=float, default=None)
    parser.add_argument("--diffusemix_semantic_sim_threshold", type=float, default=0.75)
    parser.add_argument("--diffusemix_use_cam_filter", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--diffusemix_cam_sim_threshold", type=float, default=0.6)
    parser.add_argument("--diffusemix_mask_iou_threshold", type=float, default=0.4)
    parser.add_argument("--diffusemix_use_fg_consistency", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--diffusemix_cam_threshold", type=float, default=0.5)
    parser.add_argument("--diffusemix_use_style_filter", action="store_true")
    parser.add_argument("--diffusemix_supcon_all_kept", action="store_true", help="Ablation: put all kept weak+strong DiffuseMix samples into SupCon positives")
    parser.add_argument("--diffusemix_style_min_distance", type=float, default=0.05)
