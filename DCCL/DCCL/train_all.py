...
def main():
    ...
    parser.add_argument("--diffusemix_generate_prob", type=float, default=1.0)
    parser.add_argument("--diffusemix_max_per_step", type=int, default=4)
    parser.add_argument("--diffusemix_prompt_mode", type=str, default="domain_style_only", choices=["domain_style_only"])
    parser.add_argument("--diffusemix_lambda_fg", type=float, default=0.05)
    parser.add_argument("--diffusemix_lambda_pair", type=float, default=0.0)
    parser.add_argument("--diffusemix_warmup_steps", type=int, default=0)
    parser.add_argument("--diffusemix_supcon_start_steps", type=int, default=0)
    parser.add_argument("--diffusemix_use_supcon_positive", action=argparse.BooleanOptionalAction, default=True)
